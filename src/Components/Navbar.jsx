      ...
      <nav className="Navbar">
        ...
        <li className="nav-item ">
          ...
          <li className="nav-item dropdown">
           <span onClick={toggleDropdown} className="bold-text"> <GiCrystalBars />ReactProjects</span>
           {isDropdownOpen && ( 

             <ul className="dropdown-menu">
               <li><Link to="/ReactProjects/ReactProjects1" onClick={closeMenu}>Project 1</Link></li>
               <li><Link to="/ReactProjects/ReactProjects2" onClick={closeMenu}>Project 2</Link></li>
               <li><Link to="/ReactProjects/project3" onClick={closeMenu}>Project 3</Link></li>
        </ul>
    )}
    </li>
  </ul>
