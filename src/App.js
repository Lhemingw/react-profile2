...
import items from "./Components/ReactProjects/ReactProjects1/Data";
...
import ReactProjects2 from "./ReactProjects2/index";
    ...
    <BrowserRouter>
      <div className="App">
        ...
        <Routes>
          ...
          <Route
            path="/ReactProjects/ReactProjects1"
            element={<RestaurantMenu items={items} />}
          />
          <Route
            path="/ReactProjects/ReactProjects2/"
            element={<ReactProjects2 />}
          />{" "}
          {/* New route for food ordering app */}
